...
| [drevo](https://github.com/ice1x/drevo) · [Docker image](https://hub.docker.com/r/ice1x/drevo) | Embedded graph + vector database in Rust — Neo4j-compatible Bolt/Cypher, BM25 full-text & HNSW/semantic vector search, HTTP API, plus C-FFI/WASM/Python bindings | Rust |
